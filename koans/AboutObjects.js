  ...
  it("should know properties that are functions act like methods", function () {
    var megalomaniac = {
      ...
      battleCry: function (noOfBrains) {
        // creates an array of size 5 with "undefined" as its elements and joins with "Brain" as seperator and undefined's are ignored by join
        return "They are " + this.henchman + " and the" +
        Array(noOfBrains + 1).join(" " + this.mastermind); //http://stackoverflow.com/questions/18621748/in-this-excerpt-from-javascript-koans-what-is-the-arrayfoo1-all-about
      }
    };
